...
import configureStore from './vintages/store/configureStore';
import rootSaga from './vintages/sagas';
import ReduxDomFactory from './ReduxDomFactory';
import VintageStandalone from './vintages/components/VintageStandalone';
...
class App extends ReactHabitat.Bootstrapper {
  constructor() {
    ...
    containerBuilder.register(VintageStandalone).as('RVintages');
