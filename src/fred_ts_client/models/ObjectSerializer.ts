...
let typeMap: {[index: string]: any} = {
    ...
    "CategoriesCategoriesInner": CategoriesCategoriesInner,
    "Observations": Observations,
    "ObservationsObservationsInner": ObservationsObservationsInner,
    "ReleaseDates": ReleaseDates,
    "ReleaseDatesReleaseDatesInner": ReleaseDatesReleaseDatesInner,
    "Releases": Releases,
    "ReleasesReleasesInner": ReleasesReleasesInner,
    "Seriess": Seriess,
    "SeriessSeriessInner": SeriessSeriessInner,
    "Sources": Sources,
    "SourcesSourcesInner": SourcesSourcesInner,
    "Tags": Tags,
    "TagsTagsInner": TagsTagsInner,
