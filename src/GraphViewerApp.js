...
import configureStore from './graphviewer/store/configureStore';
import rootSaga from './graphviewer/sagas';
import ReduxDomFactory from './ReduxDomFactory';
import GraphViewerMain from './graphviewer/components/main';
...
class App extends ReactHabitat.Bootstrapper {
  constructor() {
    ...
    containerBuilder.register(GraphViewerMain).as('RGraphViewer');
