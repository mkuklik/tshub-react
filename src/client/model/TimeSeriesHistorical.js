...
import TimeSeriesHistoricalAllOf from './TimeSeriesHistoricalAllOf';
import TimeSeriesUpdate from './TimeSeriesUpdate';

/**
 * The TimeSeriesHistorical model module.
 * @module model/TimeSeriesHistorical
 * @version 0.1
 */
class TimeSeriesHistorical {
    /**
     * Constructs a new <code>TimeSeriesHistorical</code>.
     * Historical definition of time series
     * @alias module:model/TimeSeriesHistorical
     * @implements module:model/TimeSeriesCore
     * @implements module:model/TSI
     * @implements module:model/TimeSeriesUpdate
     * @implements module:model/TimeSeriesHistoricalAllOf
     */
    constructor() { 
        TimeSeriesCore.initialize(this);TSI.initialize(this);TimeSeriesUpdate.initialize(this);TimeSeriesHistoricalAllOf.initialize(this);
        TimeSeriesHistorical.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeSeriesHistorical</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeSeriesHistorical} obj Optional instance to populate.
     * @return {module:model/TimeSeriesHistorical} The populated <code>TimeSeriesHistorical</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeSeriesHistorical();
            TimeSeriesCore.constructFromObject(data, obj);
            TSI.constructFromObject(data, obj);
            TimeSeriesUpdate.constructFromObject(data, obj);
            TimeSeriesHistoricalAllOf.constructFromObject(data, obj);
 ...
 * @member {String} tsid
 */
TimeSeriesHistorical.prototype['tsid'] = undefined;

/**
 * @member {String} collId
 */
TimeSeriesHistorical.prototype['collId'] = undefined;

/**
 * @member {module:model/DType} dtype
 */
TimeSeriesHistorical.prototype['dtype'] = undefined;

/**
 * parameters of data type, e.g. enum
 * @member {Object} dparams
 */
TimeSeriesHistorical.prototype['dparams'] = undefined;

/**
 * @member {module:model/IType} itype
 */
TimeSeriesHistorical.prototype['itype'] = undefined;

/**
 * @member {module:model/Frequency} freq
 */
TimeSeriesHistorical.prototype['freq'] = undefined;

/**
 * parameters of time index type, e.g. time zone if applicable, pivot date, etc
 * @member {Object} fparams
 */
TimeSeriesHistorical.prototype['fparams'] = undefined;
 ...
 */
TimeSeriesHistorical.prototype['entity'] = undefined;
 ...
 */
TimeSeriesHistorical.prototype['variable'] = undefined;

/**
 * Time Series Identifier as a string where ts name, collection name and space name as separated by comma
 * @member {String} tsi
 */
TimeSeriesHistorical.prototype['tsi'] = undefined;

/**
 * @member {String} space
 */
TimeSeriesHistorical.prototype['space'] = undefined;

/**
 * @member {String} collection
 */
TimeSeriesHistorical.prototype['collection'] = undefined;

/**
 * unique series name in a collection
 * @member {String} name
 */
TimeSeriesHistorical.prototype['name'] = undefined;

/**
 * units of values
 * @member {Object} unit
 */
TimeSeriesHistorical.prototype['unit'] = undefined;

/**
 * Title of time series
 * @member {String} title
 */
TimeSeriesHistorical.prototype['title'] = undefined;

/**
 * Detail description of time series
 * @member {String} description
 */
TimeSeriesHistorical.prototype['description'] = undefined;
 ...
 */
TimeSeriesHistorical.prototype['attributes'] = undefined;

/**
 * time when the time series definition is valid from
 * @member {Date} realStart
 */
TimeSeriesHistorical.prototype['realStart'] = undefined;

/**
 * time when the time series definition is valid until
 * @member {Date} realEnd
 */
TimeSeriesHistorical.prototype['realEnd'] = undefined;
...
// Implement TimeSeriesHistoricalAllOf interface:
/**
 * time when the time series definition is valid from
 * @member {Date} realStart
 */
...
export default TimeSeriesHistorical;
