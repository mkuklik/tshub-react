...
class CFResults extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <FormGroup>
          <Label>{(parameters.drift) ? 'With Drift.' : 'Without drift.' }</Label>
        </FormGroup>
...
export default connect(mapStateToProps, mapDispatchToProps)(CFResults);
