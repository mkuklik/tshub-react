...
export const autolagOptions = {
  AIC: 'AIC: the number of lags is chosen to minimize the Akaike information criterion',
  BIC: 'BIC: the number of lags is chosen to minimize the Bayesian information criterion',
  't-stat': 't-stat: Starts with maxlag and drops a lag until the t-statistic on the last lag length is significant using a 5%-sized test.',
  maxlag: "the 'maxlag' lags are used.",
};

class CointParameters extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <PanelContainer>
        ...
        <InputSeries ayid={ayid} label="x" paramName="x" />
        <InputSeries ayid={ayid} label="y" paramName="y" />
...
CointParameters.defaultProps = {};

CointParameters.propTypes = {
