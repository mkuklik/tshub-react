...
import { regressionOptions, autolagOptions } from './KPSSParameters';
...
class KPSSResults extends React.Component {
...
KPSSResults.defaultProps = {};

KPSSResults.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(KPSSResults);
