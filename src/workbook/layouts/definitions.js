...
export const FRED_BROWSER_FLEXLAYOUT = "FRED_BROWSER_FLEXLAYOUT";
export const FRED_BROWSER_TAB = "FRED_BROWSER_TAB";
export const FRED_BROWSER = "FRED_BROWSER";
...
export const FRED_COMP = "FRED_COMP";
export const FRED_TABLE_COMP = "FRED_TABLE_COMP";
...
export const isNodeAnalyticsTab = (nodeId) =>
  path([0], nodeId) === ANALYTICS_PREFIX;

export const GraphTabset = (i) => `${GRAPH_TABSET + i}`;

export const generateGraphTabName = (gid) =>
  `Graph ${gid.slice(gid.length - 5, gid.length)}...`;
export const generateAnalyticsTabName = (ayid) =>
  `Analytics ${ayid.slice(ayid.length - 5, ayid.length)}...`;
