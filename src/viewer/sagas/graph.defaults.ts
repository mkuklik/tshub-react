...
import { IGraphDefinitionType, IGraphType, IGraphUIType, ISeriesDefinitionType } from '../types/TGraph';


export const defaultGraph = (): IGraphType => ({
...
export const defaultSeriesDefinition = (): ISeriesDefinitionType => ({
  wsid: undefined,
  visible: true,
  type: 'line',
  dashStyle: 'Solid',
...
export const defaultGraphDefinition = ({ title, subtitle, legend }: { title?: string; subtitle?: string; legend?: boolean } = {}): IGraphDefinitionType => ({
...
export const defaultResolvedSeries = (wsid: string): IResolvedSeries => ({
  wsid,
  vid: undefined,
  realtime: undefined,
  data: [],
